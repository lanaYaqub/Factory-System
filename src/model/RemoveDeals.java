...
public class RemoveDeals extends JInternalFrame {
	...
	public RemoveDeals() {
		...
		JLabel lblNewLabel_1 = new JLabel("Deal ID");
		...
		contentPane.add(btnNewButton);
		 btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					{
						Deal deal=Main.libr.getAllDeals().get(textField.getText());
						try {
							 Main.libr.removeDeal(deal);
						} catch (TheDealIsNotFound e1) {
